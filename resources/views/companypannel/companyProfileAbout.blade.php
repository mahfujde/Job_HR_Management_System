...
<body style= "font-family Times New Roman,serif;background-color:#E5E4E2;">
      ...
      @if(empty($company_abouts))
      <div class="card cardProfile">
	  <div class="card-body m-3">
	  <form action="{{url('/save/companyabout')}}" method="post">
	  	{{csrf_field()}}
	  <label class="col-md-12 control-label" for="about_me">
	  <h5>Add Company About:</h5></label>
...
@endif
	  ...
	  <textarea class="form-control" name="about_company" type="text" rows="6" value="" placeholder=""></textarea>
	  <div class="row m-5">
     ...
     @else
      ...
      <div class="card cardProfile">
	  <div class="card-body m-3">
	  <form action="{{url('/update/companyabout')}}" method="post">
	  	{{csrf_field()}}
	  <label class="col-md-12 control-label" for="about_me">
	  <h5>Update Company About:</h5></label>
...
@endif
	  ...
	  <textarea class="form-control" name="about_company" type="text" rows="6" value="" placeholder="">{{$company_about->about_company}}</textarea>
	  <div class="row m-5">
	  <input class="form-control btn btn-success col-md-3" type="submit"  name="save"  value="Save">
	  <div class="col-md-3">
	  </div>
