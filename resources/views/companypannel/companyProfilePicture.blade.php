...
<body style= "font-family Times New Roman,serif;background-color:#E5E4E2;">
       ...
       @if(empty($company_profilepictures))
        <div class="card card-picture">
	    <div class="card-body m-3">
        <form action="{{url('/save/companyPicturePicture')}}" method="post" enctype="multipart/form-data">
        	 {{csrf_field()}}
      ...
      @foreach($company_profilepictures as $company_profilepicture)
       ...
       <div class="card card-picture">
      <div class="card-body m-3">
        <form action="{{url('/update/companyPicturePicture')}}" method="post" enctype="multipart/form-data">
           {{csrf_field()}}
        <label class="col-md-12 control-label" for="about_me">
