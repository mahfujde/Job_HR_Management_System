...
<body style= "font-family Times New Roman,serif;background-color:#E5E4E2;">
    ...
    @if(empty($company_addresses))
     <div class="card cardProfile">
	  ...
	  <form action="{{url('/save/companyaddress')}}" method="post">
	  	{{csrf_field()}}
	  <label class="col-md-12 control-label" for="education_info">
	  <h5>Add Address:</h5></label>
...
@endif
	  ...
	  <textarea class="form-control" name="company_address" type="text" rows="6" value="" placeholder=""></textarea>
	  <div class="row m-5">
      ...
      @foreach($company_addresses as $company_addresses)
      <div class="card cardProfile">
	  <div class="card-body m-3">
	  <form action="{{url('/update/companyaddress')}}" method="post">
	  	{{csrf_field()}}
	  <label class="col-md-12 control-label" for="education_info">
	  <h5>Update Address:</h5></label>
...
@endif
	  ...
	  <textarea class="form-control" name="company_address" type="text" rows="6" value="" placeholder="">{{$company_addresses->company_address}}</textarea>
	  <div class="row m-5">
