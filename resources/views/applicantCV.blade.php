...
<b>{{ $personal_information->first_name }} {{ $personal_information->last_name }}</b>
@endforeach
   @foreach($addresses as $addresse)
   <p class="ml-2 mb-1 bodycontent">{{$addresse->present_address}}.</p>
  @endforeach
  @foreach($personal_informations as $personal_information)
   <p class="ml-2 mb-1 bodycontent">{{ $personal_information->email }}</p>
   <p class="ml-2 mb-1 bodycontent">{{ $personal_information->mobile_number}}</p>
    @endforeach	
</p>
</div>
<div class="col-6">
