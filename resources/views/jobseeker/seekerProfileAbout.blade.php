...
<body style= "font-family Times New Roman,serif;background-color:#E5E4E2;">
    ...
    @endif
	  ...
	  <textarea class="form-control" name="about_me" type="text" rows="6" value="" placeholder=""></textarea>
	  <div class="row m-5">
	  ...
	  <form action="{{url('/update/about')}}" method="post">
	  	{{csrf_field()}}
	  <label class="col-md-12 control-label" for="about_me">
	  <h5>Update About:</h5></label>

	  <textarea class="form-control" name="about_me" type="text" rows="6" value="" placeholder="">{{$about->about_me}}</textarea>
	  <div class="row m-5">
