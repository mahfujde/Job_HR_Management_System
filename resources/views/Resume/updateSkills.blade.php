  ...
  <div class="card updateform">
    ...
    <div class="alert alert-danger">
        <ul>
          ...
          @endif
         <label class="col-md-12 control-label" for="education"><b>Update Professional Expertise/Skills</b></label>
            <span id="result"></span>
             <table class="table table-bordered table-striped" id="education_table">
                <thead>
                    <tr>
                        <th width="1%" style="visibility: hidden;">Sl</th>
                        <th width="89%"> Professional Expertise/Skills</th>
               ...
               @foreach($professional_expertises as $professional_expertise)
                <form method="post" action="{{url('/update/skills')}}">
                      @csrf
             <tr>
              <td>
                <input class="form-control" name="id"type="hidden" value="{{$professional_expertise->id}}">
              </td>
               <td>
                <input class="form-control" name="skill" id="skill" type="text" value="{{$professional_expertise->skill}}">
              </td>
